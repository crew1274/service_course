...
$sql = "SELECT uid FROM course WHERE id='$id'";
...
$sql = "INSERT INTO course(id,uid,year,name,first,institute,attribute,grade,subject,point,assistant,weektime,insurance,quota,choose,frequency,everytime,fix) 
VALUES ('$id','".$uid_t."','".$post['session_year']."','".$post['course_name']."','".$post['course_first_or_not']."','".$post['institute']."','".$post['cousre_attribute']."','".$post['course_grade']."','".$post['required_elective_course']."','".$post['course_point']."','".$post['is_assistant']."','".$post['course_point_time']."','".$post['is_insurance']."','".$post['student_quota']."','".$post['service_choose']."','".$post['service_frequency']."','".$post['service_times_everytime']."','".$post['is_fix_service_time']."')";
mysql_query($sql) or die($sql);
